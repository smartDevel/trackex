...
import eu.ways4.trackex.settings.presentation.SettingsActivity
import eu.ways4.trackex.about.AboutActivity
import eu.ways4.trackex.util.extensions.application
import eu.ways4.trackex.util.extensions.plusAssign
import eu.ways4.trackex.util.extensions.startActivitySafely
import eu.ways4.trackex.util.isGranted
import eu.ways4.trackex.util.isPermissionGranted
import eu.ways4.trackex.util.runOnUiThread
...
class HomeActivity : BaseActivity() {
    ...
    private fun navigateToSupport() {
        eu.ways4.trackex.about.AboutActivity.start(this)
    }
